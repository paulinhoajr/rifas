...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Imagens de {{ $premio->nome }}</h1>
    ...
    <div class="">
        ...
        <form action="{{ route('admin.premios.upload') }}" method="post" enctype="multipart/form-data">
...
@section('scripts')
    ...
    <script>
        ...
        function  executaFuncao(){
            ...
            $.getJSON( "/admin/premios/list/{{ $premio->id }}", function( data ) {

                $.each( data, function( key, val ) {

                    $('.resultado').append(
                        '<div class="col-md-3">' +
                        '<img src="/storage/images/premios/thumbs/'+val.caminho+'" width="100%" />' +
